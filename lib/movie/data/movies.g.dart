...
Casts _$CastsFromJson(Map<String, dynamic> json) {
  return Casts(
      ...
      json['avatars'] == null
          ? null
          : CastAvatars.fromJson(json['avatars'] as Map<String, dynamic>),
      json['name'] as String,
      json['id'] as String);
}
...
CastAvatars _$CastAvatarsFromJson(Map<String, dynamic> json) {
  return CastAvatars(json['small'] as String, json['large'] as String,
      json['medium'] as String);
}

Map<String, dynamic> _$CastAvatarsToJson(CastAvatars instance) =>
    <String, dynamic>{
...
Directors _$DirectorsFromJson(Map<String, dynamic> json) {
  return Directors(
      ...
      json['avatars'] == null
          ? null
          : DirectorsAvatars.fromJson(json['avatars'] as Map<String, dynamic>),
      json['name'] as String,
      json['id'] as String);
}
...
DirectorsAvatars _$DirectorsAvatarsFromJson(Map<String, dynamic> json) {
  return DirectorsAvatars(json['small'] as String, json['large'] as String,
      json['medium'] as String);
}

Map<String, dynamic> _$DirectorsAvatarsToJson(DirectorsAvatars instance) =>
    <String, dynamic>{
      'small': instance.small,
      'large': instance.large,
      'medium': instance.medium

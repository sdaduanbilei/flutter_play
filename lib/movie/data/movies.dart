...
@JsonSerializable()
  ...
  Subjects(this.rating,this.genres,this.title,this.casts,this.collect_count,this.original_title,this.subtype,this.directors,this.year,this.images,this.alt,this.id,);
...
@JsonSerializable()
  class CastAvatars extends Object {
  ...
  CastAvatars(this.small,this.large,this.medium,);

  factory CastAvatars.fromJson(Map<String, dynamic> srcJson) => _$CastAvatarsFromJson(srcJson);
...
@JsonSerializable()
  class DirectorsAvatars extends Object {
  ...
  DirectorsAvatars(this.small,this.large,this.medium,);

  factory DirectorsAvatars.fromJson(Map<String, dynamic> srcJson) => _$DirectorsAvatarsFromJson(srcJson);

  Map<String, dynamic> toJson() => _$DirectorsAvatarsToJson(this);
